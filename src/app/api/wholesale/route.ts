...
export async function GET() {
  ...
  try {
    ...
    type Row = { id: string; cigar_name: string; vitola: string | null; cigars_per_box: number; price_per_box_cents: number; boxes_available: number; moq_boxes: number; image_url: string | null; brand_id: string; brands: { name: string; slug: string; tier: string; verified: boolean } };
